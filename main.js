$( document ).ready( function() {
    ...
    function newActivity() {
        ...
        $( '.activityContent' ).hide().prepend('<div class="activity">' +
           '<ul>' +
           		'<li><img class="avatar" src="https://cdn.jsdelivr.net/gh/leniwidi/hpt2/img/avatar.jpg" alt="avatar" /><img class="flag" src="https://cdn.jsdelivr.net/gh/leniwidi/hpt2/img/flags/'+flag+'.png" alt="flag" /></li>' +
